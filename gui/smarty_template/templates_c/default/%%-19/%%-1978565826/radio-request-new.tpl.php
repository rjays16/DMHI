<?php /* Smarty version 2.6.0, created on 2017-05-08 14:47:33
...
<span  id="ExceedPhic" style="font-weight:bold;color:red"><?php echo $this->_tpl_vars['sWarningPhicExceed']; ?>
</span>
	<table border="0" align="center" style="margin-bottom:2px" >
	<tr>
				<td width="1"><strong style="white-space:nowrap">PHILhealth Exceed</strong></td>
				<td width="*"><?php echo $this->_tpl_vars['sCheckIfExceed']; ?>
</td>
	</tr>
</table>
...
-->
					...
					<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
						<tr>
							<td colspan="4">
								<table>
									<td align="right" width="13%" valign="middle"><strong>File Number</strong></td>
									<td width="30%"><?php echo $this->_tpl_vars['sRID'];  echo $this->_tpl_vars['sRIDbtn']; ?>
</td>
									<td align="right" width="5%" valign="middle"><strong>HRN</strong></td>
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
							...
							<tr>
								...
								<td valign="top" width="20%">
									<span id="company" style="font-weight:bold;color:#000080"><?php echo $this->_tpl_vars['scompany_name']; ?>
</span>
								</td>
								<!--added by daryl-->
							</tr>
