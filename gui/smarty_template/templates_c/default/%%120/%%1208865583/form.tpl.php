<?php /* Smarty version 2.6.0, created on 2017-05-30 15:48:38
  ...
  <br /> <?php endif; ?>
        ...
        <tr bgcolor="#f6f6f6">
            <td valign="top">
                <table width="200" border="0" bordercolor="#F6F6F6">
                    <tr>
                        <td height="100" valign="top">Remarks</td>
                    </tr>
                </table>            
            </td>
    ...
    <?php endif; ?>
     <?php endif; ?>
            ...
            <tbody id="bodyDischarge2">
                <tr bgcolor="#f6f6f6">
                    <td>Date and Time Paid Bill</td>
                    <td><?php echo $this->_tpl_vars['PaidBill']; ?>
</td>
                </tr>
         <?php if ($this->_tpl_vars['sAdmittedOpd_b']): ?>
