<?php /* Smarty version 2.6.0, created on 2019-09-20 14:12:53
...
:
 ...
 &nbsp; <?php echo $this->_tpl_vars['sCrossImg']; ?>
					...
					<td class="adm_item">
						<?php echo $this->_tpl_vars['LDSuffix']; ?>
:
					</td>
					<td bgcolor="#ffffee" class="vi_data">
...
-->
			...
			<?php if ($this->_tpl_vars['segORNumber']): ?>
				<tr>
					<td class="adm_item">
						<font><?php echo $this->_tpl_vars['segORNumber']; ?>
</font>:
					</td>
					<td colspan=2 class="adm_input">
...
-->
				...
				<!-- <?php if ($this->_tpl_vars['segCompany']): ?>
					<tr id="complaint_assignment" style="display">
						<td class="adm_item">
							<?php echo $this->_tpl_vars['segCompanyLabel']; ?>
:
						</td>
						<td colspan=2 class="adm_input">
							<?php echo $this->_tpl_vars['removeCompany']; ?>
 <?php echo $this->_tpl_vars['segCompanyName']; ?>
