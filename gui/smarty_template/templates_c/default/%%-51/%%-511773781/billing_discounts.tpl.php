<?php /* Smarty version 2.6.0, created on 2017-05-03 16:09:13
	...
	<table class="segList" width="94%" id="discounts_tbl" name="discounts_tbl" cellpadding="0" cellspacing="1" style="display:none">
		<thead>
			<tr>
                ...
                <th width="14%"><span style="font-size:12px;">Hospital<br>Discount</span></th>
                <th width="14%"><span style="font-size:12px;">Profession Fee<br>Discount</span></th>
		...
		<table width="100%" class="segPanel">
			<tbody>
				...
				<tr style="display:none">
					<td align="right" id="discountlbl"><b>Discount (%):</b></td>
					<td><input style="text-align:right" onblur="trimString(this); genChkDecimal(this, 4); clearOtherField(this,  'Hospdiscount', 'Profdiscount', 1);" onFocus="this.select();" id="discount" name="discount" value="" /></td>
				</tr>
		
				<tr style="display:none">
					<td align="right" id="Hospdiscountlbl"><b>Hospital Discount:</b></td>
					<td><input style="text-align:right" onkeyup="checkhci_amount(this);" onblur="trimString(this); genChkDecimal(this, 2); clearOtherField(this, 'discount' , 0, 0);" onFocus="this.select();" id="Hospdiscount" name="Hospdiscount" value="" /></td>
				</tr>                
				<tr style="display:none">
					<td align="right" id="Profdiscountlbl"><b>Profession Discount:</b></td>
					<td><input style="text-align:right" onkeyup="checkpf_amount(this);" onblur="trimString(this); genChkDecimal(this, 2); clearOtherField(this, 'discount',  0, 0);" onFocus="this.select();" id="Profdiscount" name="Profdiscount" value="" /></td>
				</tr>
