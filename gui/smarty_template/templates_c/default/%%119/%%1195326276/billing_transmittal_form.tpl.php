<?php /* Smarty version 2.6.0, created on 2017-05-05 19:20:42
...
>
				<td align="left" colspan="6"><?php echo $this->_tpl_vars['sBtnAddItem'];  echo $this->_tpl_vars['sBtnDelete']; ?>
								...
								<td align="right"><?php echo $this->_tpl_vars['btnXml'];  echo $this->_tpl_vars['sBtnPrint'];  echo $this->_tpl_vars['sBtnSave2']; ?>
</td>
								<td align="right"><?php echo $this->_tpl_vars['sCheckboxSur'];  echo $this->_tpl_vars['sCheckboxMed'];  echo $this->_tpl_vars['sCheckboxCas'];  echo $this->_tpl_vars['sBtnSummary'];  echo $this->_tpl_vars['sBtnPrint2'];  echo $this->_tpl_vars['sBtnSave']; ?>
</td>
			</tr>
		</tbody>
	</table>
	<table id="transmit_details" class="segList" border="0" cellpadding="0" cellspacing="0" width="90%">
		<thead id="tbl_transmit_details_hdr">
			<tr>
								...
								<th width="2%">&nbsp;</th>
								<!-- <th width="2%">&nbsp;</th> -->
								<?php echo $this->_tpl_vars['sTransmittalPrintHeader']; ?>
...
<!--added by daryl -->
<div id="prompt_altername" style="display:none">
<div class="hd" align="left">UPDATE NAME:</div>
<div class="bd">
		<form id="formdbox" method="post" action="document.location.href">
				<table width="100%" class="segPanel">
						<tbody>
								<tr>
										<td align="right" width="*">First Name:</td>
										<td align="left">
										<input type="input" id="alter_fname" name="alter_fname" value="" />											
										</td>
								</tr>
								<tr>
										<td align="right" width="*">Middle Name:</td>
										<td align="left">
										<input type="input" id="alter_mname" name="alter_mname" value="" />											
										</td>
								</tr>
								<tr>
										<td align="right" width="*">Last Name:</td>
										<td align="left">
										<input type="input" id="alter_lname" name="alter_lname" value="" />											
										</td>
								</tr>
								<tr>
										<td align="right" width="*">Name Extension:</td>
										<td align="left">
										<input type="input" id="alter_exname" name="alter_exname" value="" />											
										</td>
								</tr>
										<input type="hidden" id="encounter_nrs" name="encounter_nrs" value="" />											
...
&nbsp;&nbsp;<label for="date">Time (24-hour format): </label><input type="text" id="dischrgtme" name="dischrgtme" size="6" onblur="checkTimeInput(this.value);" readOnly/></td>
								</tr>
								<!-- <tr> -->
...
images/loading6.gif" align="absmiddle" border="0" style="display:none"/>
								  ...
								  <td colspan="4" align="center">
								  		...
								  		<!-- <button onclick="show_diag_box()" id="btnDiagnosis" name="btnDiagnosis" class=" ui-icon-lightbulb" type="button" style="margin-left: 4px; height: 30px; width: 400px; cursor: pointer; font:bold 12px Arial;">
        								  	Diagnosis And Procedure
        								  </button> -->
        								  <input  onclick="show_diag_box()" id="btnDiagnosis" name="btnDiagnosis" class=" ui-icon-lightbulb" type="button" style="margin-left: 4px; height: 30px; width: 400px; cursor: pointer; font:bold 12px Arial;" value="Diagnosis And Procedure"/>
								<!--   <input id="btnDiagnosis" name="btnDiagnosis" class="segList" value="Diagnosis And Procedure" type="button" style="margin-left: 4px; height: 30px; width: 200px; cursor: pointer; font:bold 12px Arial;"/> -->
								  </td>
								</tr>
								<tr>
									<td colspan="4">
