<?php /* Smarty version 2.6.0, created on 2017-05-08 14:36:12
 ...
 ?>
	...
	<ul id="request-tabs" class="segTab" style="padding-left:10px;">
			...
			<h2 class="segTabText">Other Payments</h2>
						...
						<li id="tab_copayment" <?php if ($this->_tpl_vars['bTabCopayment']): ?>class="segActiveTab"<?php endif; ?> onclick="tabClick(this)" segTab="copayment">
			<h2 class="segTabText">Service Payments</h2>
		</li>
	</ul>
	...
	<?php echo $this->_tpl_vars['sRequests']; ?>
		...
		<div id="billing" style="padding:2px;padding-top:3px;<?php if (! $this->_tpl_vars['bTabBilling']): ?>display:none<?php endif; ?>">
			<div align="left" style="margin:2px; color:#888888">
				<?php echo $this->_tpl_vars['sBillingAdd'];  echo $this->_tpl_vars['sBillingRemove'];  echo $this->_tpl_vars['sBillingDoctor'];  echo $this->_tpl_vars['sBillingClear']; ?>
...
|
	...
	<div id="copayment" style="padding:2px;padding-top:3px;<?php if (! $this->_tpl_vars['bTabCopayment']): ?>display:none<?php endif; ?>">
			<div align="left" style="margin:2px; color:#888888">
				<?php echo $this->_tpl_vars['PaymentAdd']; ?>
 | <?php echo $this->_tpl_vars['PaymentClear']; ?>

			</div>
							<!-- company payment dashlet -->
							<div id="sp_dashlet" class="dashlet" style="margin-top:15px">
								<table class="dashletHeader" cellpadding="0" cellspacing="0">
									<tr>
										<td width="1%" nowrap="nowrap">
								...
								<div id="sp_dashlet_content">
			<input name="requests[]" type="hidden" srcDept="sp" refNo="0000000000" value="sp0000000000"/>
			<input name="iscash[]" type="hidden" srcDept="sp" refNo="0000000000" value="1"/>
			<table id="list_sp0000000000" class="segList" border="0" cellpadding="0" cellspacing="0" style="width:100%;">
				<thead>
					<tr id="row_sp0000000000">
						<th width="3%" class="centerAlign"><input type="checkbox" onchange="flagCheckBoxesByName('sp0000000000[]',this.checked); calcSubTotal('sp','0000000000')" checked="checked"></th>
						<th align="left" width="10%" nowrap>Item No</th>
						<th align="left" width="*" nowrap="nowrap">Item Description</th>
						<th align="right" width="9%" nowrap="nowrap" style="font-size:90%">Price/item (Orig)</th>
						<th align="right" width="9%" nowrap="nowrap" style="font-size:90%">Price/item (Adj)</th>
				...
				<tbody>
	<?php echo $this->_tpl_vars['PaymentList']; ?>

				</tbody>
				<tfoot>
					<tr>
						<th align="left" nowrap="nowrap"><img class="segSimulatedLink" src="../../images/cashier_up_small.gif" align="absmiddle" onclick="toggleTBody('list_sp0000000000')" /></th>
						<th align="left" colspan="3" nowrap="nowrap">Items (<span id="items_sp0000000000">0</span>)</th>
						<th align="right" nowrap="nowrap">Orig Subtotal:</th>
						<th align="left" nowrap="nowrap" style="font-weight:normal">
							<input type="hidden" id="subtotal_orig_sp0000000000" name="subtotal_orig_sp0000000000" value="0"/>
							<span style="" id="show_subtotal_orig_sp0000000000">0.00</span>
						</th>
						<th align="right" nowrap="nowrap">Adj Subtotal:</th>
						<th align="left" nowrap="nowrap" style="font-weight:normal" colspan="2">
							<input type="hidden" id="charity_sp0000000000" name="charity_sp0000000000" value="-1"/>
							<input type="hidden" id="charity_icon_sp0000000000" disabled="disabled"/>
							<input type="hidden" id="subtotal_sp0000000000" name="subtotal_sp0000000000" value="0.00"/>
							<span style="" id="show_subtotal_sp0000000000">0.00</span>
						</th>
					</tr>
				</tfoot>
			</table>
