<?php /* Smarty version 2.6.0, created on 2019-05-16 14:16:52
        ...
        <table width="96%" cellpadding="0" cellspacing="3">
            <tbody id="buttons_bar">
                <tr>
                    ...
                    <td width="*">&nbsp;</td>
                    <!-- <?php echo $this->_tpl_vars['sBtnCSFp1']; ?>
 -->
                    ...
                    <!-- <?php echo $this->_tpl_vars['sBtnPrintOld']; ?>
 -->
                    <?php echo $this->_tpl_vars['sBtnPrint']; ?>

                    <?php echo $this->_tpl_vars['sBtnCF2Part3']; ?>

                    <?php echo $this->_tpl_vars['sBtnCF2Part4']; ?>
...
&nbsp;MEMBERSHIP CATEGORY:<img id="btnEditMemCat" src="../../images/cashier_edit.gif" style="cursor: pointer;" align="absmiddle"/>&nbsp;<span id="mcategdesc" name="mcategdesc"></span></div></th>
                    ...
                    <td colspan="2" rowspan="5" align="left" valign="top" class="jedPanel">
                        <table width="100%" border="0" cellpadding="2" cellspacing="0" style="font-size:11px">
                            <tr class="jedPanel">
                                    ...
                                    <td width="*" align="right"><strong>Birth Date :</strong></td>
                                    <td width="50px" align="left"><?php echo $this->_tpl_vars['sBirthDate']; ?>
</td>
                    ...
                    <tbody class="billfooter" id="footer_subTotalDetails">
                        <tr>
                            ...
                            <td class="billftr2" align="right" colspan="2">
                                ...
                                <a id="hcidiscount"   style="cursor:pointer">Discount</a><br />
                                <div id="hcitipscovrg" style="display:none">This is applicable for other insurances. </div>
                                <a id="hcicvrg" onmouseout="return nd();" onmouseover="return overlib($('hcitipscovrg').innerHTML, LEFT);"  style="cursor:pointer">[Health Insurance] Total Coverage</a><br />
                                <span>Excess</span>
                            </td>
                            <td align="right" width="15%">
                                <b><span id="hiTotal">0.00</span><br /></b>
                                <b><span id="hiDiscount">0.00</span><br /></b>
                                <b><span id="hiHIC">0.00</span><br /></b>
                                <b><span id="hiEX">0.00</span></b>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody class="billfooter" id="footer_docRoleArea">
                        <tr>
                            ...
                            <td class="billftr2" align="right" colspan="2">
                                ...
                                <a id="proffdiscount"   style="cursor:pointer">Discount</a><br />
                                <span>
                            ...
                            <td align="right" width="15%">
                                <b><span id="pfAP">0.00</span><br /></b>
                                <b><span id="pfDiscount">0.00</span><br /></b>
                                <b><span id="pfHC">0.00</span><br /></b>
                                <b><span id="pfEX">0.00</span></b>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
&nbsp;Please wait ... computing amount due.
                        ...
                        <td align="right" id="netbill"style="font-weight:bold;">00.00</td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <span id="lastProgBar" style="display:none; font:bold 12px Arial, Helvetica, Sans-Serif">
...
&nbsp;Please wait ... computing amount due.
                        ...
                        <td align="right" id="HealthInsuranceTotal"style="font-weight:bold;">00.00</td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <span id="lastProgBar" style="display:none; font:bold 12px Arial, Helvetica, Sans-Serif">
...
&nbsp;Please wait ... computing amount due.
                        ...
                        <td align="right" id="DiscountTotal"style="font-weight:bold;">00.00</td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <span id="lastProgBar" style="display:none; font:bold 12px Arial, Helvetica, Sans-Serif">
...
&nbsp;Please wait ... computing amount due.
                        ...
                        <td align="right" id="bdeposit"style="font-weight:bold;">00.00</td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <span id="lastProgBar" style="display:none; font:bold 12px Arial, Helvetica, Sans-Serif">
...
&nbsp;Please wait ... computing amount due.
                            ...
                            <span id="amntlabel">Previous Balance :</span>
                        </td>
                        <td align="right" id="prev_bal"style="font-weight:bold;">00.00</td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <span id="lastProgBar" style="display:none; font:bold 12px Arial, Helvetica, Sans-Serif">
...
&nbsp;Please wait ... computing amount due.
                        ...
                        <td align="right" id="netamnt" style="font-weight:bold;">00.00</td>
                    </tr>
                </table>
            </td>
        </tr>
...
<div id="coverage-dialog-hci" style="display:none">
    <table width="100%" class="segList">
        <thead id="hf-coverage-header">
        </thead>
        <tbody id="hf-hci-coverage">
        </tbody>
        <tfoot id="hf-coverage-footer">
        </tfoot>
    </table>
    <br/>
    <table width="100%" class="segList">
        <thead>
            <tr>
                ...
                <th width="10%" nowrap="nowrap">Total Discount</th>
                <th width="10%" nowrap="nowrap">PHIC LIMIT</th>
                <th width="10%" nowrap="nowrap">PHIC</th>
                <th width="10%" nowrap="nowrap">HMO</th>
                <th width="10%" nowrap="nowrap">COMPANY</th>
                <th width="10%" nowrap="nowrap">Hospital Charges</th>
                <th width="15%" nowrap="nowrap">Excess</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td align="left"><b>Hospital Charges</b></td>
                <td align="center" id="hf_discount"></td>
                <td align="center" id="hf_phic_limit"></td>
                <td align="center" id="hf_phic"></td>
                <td align="center"  id="hf_hmo"></td>
                <td align="center"  id="hf_comp"></td>
                <td align="center"  id="hf_excess"></td>
                <td width="15%"  align="center" nowrap="nowrap" id="HC_total"></td>
            </tr>
            <tfoot>
                <tr>
                    <th width="20%"> </th>
                    <th width="10%" align="left" nowrap="nowrap" id="hf_discount"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="phic_hf_limit_total"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="phic_hf_total"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="hmo_total"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="comp_total"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="excess_total"></th>
      ...
      <table width="100%" class="segList">
        <thead>
            <tr>
                <th width="20%" ></th>
                <th width="10%" nowrap="nowrap">LAB</th>
                <th width="10%" nowrap="nowrap">RAD</th>
                <th width="10%" nowrap="nowrap">PHA</th>
                <th width="10%" nowrap="nowrap">MISC</th>
                <th width="10%" nowrap="nowrap">OR</th>
                <th width="15%" nowrap="nowrap">TOTAL</th>
            </tr>
        </thead>
        <br/>
        <tbody>
            <tr>
                <td align="left"><b>Company Charges</b></td>
                <td align="center" id="com_lab"></td>
                <td align="center" id="com_rad"></td>
                <td align="center"  id="com_pha"></td>
                <td align="center"  id="com_misc"></td>
                <td align="center"  id="com_or"></td>
                <td width="15%"  align="center" nowrap="nowrap" id="com_total"></td>
            </tr>
            <tfoot>
                <tr>
                    <th width="20%"> </th>
...
<div id="discount-dialog-hci" style="display:none">
    <table width="100%" class="segList">
        <thead id="hf-discount-header">
        </thead>
        <tbody id="hf-hci-discount">
        </tbody>
        <tfoot id="hf-discount-footer">
        </tfoot>
    </table>
    <br/>
      <table width="100%" class="segList">
        ...
        <tbody>
            <tr>
                <td align="left"><b>Hospital Charges</b></td>
                <td align="center" id="hf_discount_disc"></td>
                <td align="center" id="hf_phic_disc"></td>
                <td align="center"  id="hf_hmo_disc"></td>
                <td align="center"  id="hf_comp_disc"></td>
                <td align="center"  id="hf_excess_disc"></td>
                <td width="15%"  align="center" nowrap="nowrap" id="HC_total_disc"></td>
            </tr>
            <tfoot>
                <tr>
                    <th width="20%"> </th>
                    <th width="10%" align="left" nowrap="nowrap" id="hf_discount_disc"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="phic_hf_total_disc"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="hmo_total_disc"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="comp_total_disc"></th>
                    <th width="10%" align="left" nowrap="nowrap" id="excess_total_disc"></th>
                    <th width="15%" align="left"></th>
                </tr>
...
<!--  for Doctor Discount -->
<div id="coverage-dialog-disc" style="display:none">
    <table class="segList" width="100%" border="1" cellspacing="0" cellpadding="0">
        <thead id="coverage-header-disc">
        </thead>
        <tbody id="hci-coverage-disc">
        </tbody>
        <tbody id="doc-coverage-disc">
        </tbody>
        <tfoot id="coverage-footer-disc">
        </tfoot>
    </table>
    <br/>
     <table width="100%" class="segList">
        ...
        <tbody>
            <tr>
                <td align="left"><b>General Practitioner / Specialist</b></td>
                <td align="left" id="D1_first_disc"></td>
                <td align="left"  id="D1_second_disc"></td>
                <td width="30%"  align="left" nowrap="nowrap" id="D1_total_disc"></td>
            </tr>
             <tr>
                <td align="left"><b>Surgeon</b></td>
                <td align="left" id="D3_first_disc"></td>
                <td align="left" id="D3_second_disc"></td>
                <td width="30%" align="left" nowrap="nowrap" id="D3_total_disc"></td>
            </tr>
            <tr>
                <td align="left"><b>Anesthesiologist</b></td>
                <td align="left" id="D4_first_disc"></td>
                <td align="left" id="D4_second_disc"></td>
                <td width="30%" align="left" nowrap="nowrap" id="D4_total_disc"></td>
            </tr>
            <tfoot>
                <tr>
                    <th width="40%">MAX PHIC PF </th>
                    <th width="30%" align="left" nowrap="nowrap" id="first_total_disc"></th>
                    <th width="30%" align="left" nowrap="nowrap" id="second_total_disc"></th>
                    <th align="left"><span style="text-align:left;font:bold 15px Arial"  id="phic-max-PF_disc" name="phic-max-PF_disc" ></span></th>
                </tr>
...
<!-- ended by daryl-->
<input type="hidden" id="temphcidiscount" name="temphcidiscount">
<input type="hidden" id="temppfdiscount" name="temppfdiscount">
