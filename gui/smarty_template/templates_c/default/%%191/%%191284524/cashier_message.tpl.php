<?php /* Smarty version 2.6.0, created on 2019-01-24 11:41:30
...
');
		window.open('<?php echo $this->_tpl_vars['draftPrintURL']; ?>
', "Print OR Form", "toolbar=no, status=no, menubar=no, width=700, height=500, location=center, dependent=yes, resizable=yes, scrollbars=yes, top=" + ntop + ",left=" + nleft);
	});
...
unset($_smarty_tpl_vars);
 ?>
	...
	<div align="right">
       ...
       <?php echo $this->_tpl_vars['ORprint_cashier']; ?>

         
       <?php echo $this->_tpl_vars['ORprint_pharma']; ?>
