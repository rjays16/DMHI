...
<div style="width:98%">
	...
	<ul id="request-tabs" class="segTab" style="padding-left:10px;">
			...
			<h2 class="segTabText">Other Payments</h2>
						...
						<li id="tab_copayment" {{if $bTabCopayment}}class="segActiveTab"{{/if}} onclick="tabClick(this)" segTab="copayment">
	...
	{{$sRequests}}
		...
		<div id="billing" style="padding:2px;padding-top:3px;{{if !$bTabBilling}}display:none{{/if}}">
			<div align="left" style="margin:2px; color:#888888">
				{{$sBillingAdd}}{{$sBillingRemove}}{{$sBillingDoctor}}{{$sBillingClear}}
			</div>
	...
	<div id="copayment" style="padding:2px;padding-top:3px;{{if !$bTabCopayment}}display:none{{/if}}">
			<div align="left" style="margin:2px; color:#888888">
				{{$PaymentAdd}} | {{$PaymentClear}}
			</div>
