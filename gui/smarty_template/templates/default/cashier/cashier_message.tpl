...
jQuery(function($) {
	$('#btn-print-draft').click(function(e){
		...
		window.open('{{$draftPrintURL}}', "Print OR Form", "toolbar=no, status=no, menubar=no, width=700, height=500, location=center, dependent=yes, resizable=yes, scrollbars=yes, top=" + ntop + ",left=" + nleft);
	});
