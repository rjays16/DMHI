...
{{$sFormStart}}
	...
	<span  id="ExceedPhic" style="font-weight:bold;color:red">{{$sWarningPhicExceed}}</span>
				...
				<td rowspan="3" class="segPanel" align="center" valign="top">
					...
					<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
						<tr>
							...
							<td colspan="3" valign="middle"></strong><span id="hrn" style="font:bold 12px Arial; color:#0000FF;">{{$sPatientHRN}}{{$sPatientHRN_}}</span></td>
						</tr>
						<tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
							...
							<tr>
								...
								<td valign="top" width="20%">
									<span id="company" style="font-weight:bold;color:#000080">{{$scompany_name}}</span>
								</td>
								<!--added by daryl-->
							</tr>
							<tr>
...
{{$sOrderItems}}
			...
			<tbody id="socialServiceNotes" style="display:none">
				<tr>
					<td colspan="12">{{$sSocialServiceNotes}}</td>
				</tr>
			</tbody>
		</table>
