						...
						<tr class="segPanel">
							...
							<td>{{$sHCareAddress}}</td>
												...
												<tr class="segPanel">
														...
														<td valign="middle" align="left">{{$sTransmitNo}}</td>
												</tr>
												<tr class="segPanel">
		...
		<tbody id="tbl_transmit_details_header">
			...
			<tr id="tbl_transmit_details_hdr_row2" {{$sShowButtons}}>
				<td align="left" colspan="6">{{$sBtnAddItem}}{{$sBtnDelete}}</td>
								<td align="right">{{$btnXml}}{{$sBtnPrint}}{{$sBtnSave2}}</td>
								<td align="right">{{$sCheckboxSur}}{{$sCheckboxMed}}{{$sCheckboxCas}}{{$sBtnSummary}}{{$sBtnPrint2}}{{$sBtnSave}}</td>
			</tr>
		</tbody>
	</table>
				...
				<table width="100%" class="segPanel">
						...
						<tbody>
								...
								<tr>
										...
										<td align="left" colspan="3">{{$sDischargeDate}}&nbsp;&nbsp;<label for="date">Time (24-hour format): </label><input type="text" id="dischrgtme" name="dischrgtme" size="6" onblur="checkTimeInput(this.value);" readOnly/></td>
								</tr>
								<!-- <tr> -->
