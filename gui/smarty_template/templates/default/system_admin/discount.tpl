			...
			<table class="segList" width="100%" border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr class="reg_list_titlebar" >
						<th width="9%" align="center"><strong>ID</strong></td>
						<th width="29%" align="center"><strong>Description</strong></td>
						<th width="9%" align="center"><strong>Discount<br>(in %)</strong></td>
						<!--added by VAN 06-18-08 -->
						<th width="19%" align="center"><strong>Area Used</strong></td>
						<th width="7%" align="center"><strong>After<br >bill</strong></td>
						<th width="14%" align="center"><strong>Applied<br>Areas</strong></td>
						<!-- -->
				...
				<tbody>
					<tr>
						...
						<td><input id="IsBillFinal" type="checkbox"	 style="width:100%; font:bold 12px Arial"></td>
						<td align="center">
						...
						<!-- <td><input id="IsAfterBill" type="checkbox" style="width:100%; font:bold 12px Arial"></td> -->
			...
			<table class="segList" width="100%" border="0" cellpadding="0" cellspacing="0" id="discountTable">
				<thead>
					<tr class="reg_list_titlebar" style="font-weight:bold;height:24px" id="discountRowHeader">
						...
						<!-- added by poliam 03/11/2014 -->
						<th width="9%" align="center"><strong>After<br >bill</strong></th>
						<th width="*">Options</th>
					</tr>
				</thead>
				<tbody>
