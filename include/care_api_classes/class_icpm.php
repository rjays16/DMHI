...
class Icpm extends Core{
	...
	var $seg_case_rate_packages='seg_case_rate_packages';
...
*/		$this->_useSegIcpm();
	...
	*/
	...
	//added by daryl
		function getIcpmInfo_seg($icpmCode){
		global $db;	
		if(empty($icpmCode)) return FALSE;
		
	
			$this->sql="SELECT * FROM seg_case_rate_packages WHERE code='$icpmCode'";	
...
#added by daryl
		//08/30/2014
				function get_SelectedICPM($sfilter = '') {
				global $db;
		...
		function get_SelectedICPDesc($sfilter = '') {
				global $db;
