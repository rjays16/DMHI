	...
	class SegRequestCancel extends Core {
		...
		function getLaboratoryRequests($filters, $sort, $offset, $maxrows)
		{
			...
			$this->sql = "SELECT SQL_CALC_FOUND_ROWS \n".
									...
									"(SELECT b.is_final FROM seg_billing_encounter AS b WHERE b.encounter_nr = l.encounter_nr) AS is_final_bill, \n".
  									"(SELECT ce.is_discharged FROM care_encounter AS ce WHERE ce.encounter_nr = l.encounter_nr) AS is_discharged \n".
