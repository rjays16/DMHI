...
class GlobalConfig  extends Core{
	...
	*/
     ...
     * Using global config for dynamic values of E-Claims Status Report.



     * @author Jeff Ponteras - 05/15/18
    ...
    function getEclaimsStatusInfo(){
        global $db;
	       ...
	       $sql = "SELECT 
	                ...
	                FROM
	                  `care_config_global` AS ccg 
	                WHERE ccg.`type` = 'eclaims_status_report' ";
