...
ob_start();
?>
<input type="hidden" id="spf_excess" name="spf_excess" value="<?php echo $_GET['spf_excess']; ?>" />
<input type="hidden" id="shci_excess" name="shci_excess" value="<?php echo $_GET['shci_excess']; ?>" />
