...
// $smarty->assign('pbBack',$returnfile);
 ...
 $smarty->assign('sOnLoadJs','onLoad="getPharmaAreas();document.getElementById(\'search\').focus();"');
...
<script type="text/javascript" src="<?=$root_path?>modules/billing_new/js/billing-misc-services-tray-new.js?t=<?=time()?>"></script>
<script type="text/javascript" src="<?=$root_path?>modules/billing_new/js/billing-common.js"></script>
<?php
...
?>
<div class="segPanel" id="" align="left">
    <div align="center" style="overflow:hidden">
	<table width="98%" cellspacing="2" cellpadding="2" style="margin:0.7%" class="data-grid rounded-borders-bottom">
		<tbody>
			<tr>
			...
			<tr>
				<td colspan="2">
					<div style="display:block; border:1px solid #8cadc0; overflow-y:scroll; height:305px; width:100%; background-color:#e5e5e5">
						<table id="miscellaneous-list" class="segList" cellpadding="1" cellspacing="1" width="100%">
							<thead>
								<tr class="nav">
								...
								<tr>
									<th align="center" width="12%" nowrap>Code</th>
									<th align="center" width="*" nowrap>Name</th>
									<th align="center" width="12%" nowrap="nowrap">Source</th>
									<th align="center" width="18%" nowrap="nowrap">Account</th>
									<th align="center" width="18%" nowrap="nowrap">Subtype</th>
									<th align="center" width="14%" nowrap="nowrap">Charge</th>
									<th align="center" width="2%" nowrap="nowrap">Qty</th>
									<th align="center" width="2%">&nbsp;</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td colspan="8" style="font-weight:normal">No such miscellaneous service exists...</td>
								</tr>
							</tbody>
						</table>
