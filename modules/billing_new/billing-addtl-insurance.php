...
<script type="text/javascript" src="js/billing-addtl-insurance.js"></script>
<?php
$xajax->printJavascript($root_path.'classes/xajax');
?>
<script>
	YAHOO.namespace("discount.container");
	YAHOO.util.Event.onDOMReady(initInsuranceDialogBox);
...
$smarty->assign('sOnLoadJs','onLoad="showProgressBar();js_getApplicableInsurance()"');
...
<input type="hidden" id="insurance_desc" name="insurance_desc" value="" />
<?php
$sTemp = ob_get_contents();
ob_end_clean();
...
$smarty->assign('sMainBlockIncludeFile','billing_new/billing-addtl-insurance.tpl');
 /**
 * show Template
 */
