...
<script type="text/javascript" src="js/special-procedures.js?t=<?=time();?>"></script>
...
if ($_GET['nr'] == '') {
        ...
        $smarty->assign('sBtnSave', '<td width="8" valign="bottom" align="left">
        								...
        								Save</button></td>');
        // $smarty->assign('sBtnPrintOld', '<td width="10" valign="bottom" align="left">
        // 								<button id="btnPrintOld" onclick="js_btnHandler_Old()" name="btnPrintOld" class="" type="submit" style="margin-left: 4px; height: 30px; width: 90px; cursor: pointer; color:#000; font:bold 12px Arial;">
        // 								Print Old</button></td>');
        ...
        $smarty->assign('sBtnCSFp1', '<td width="19" valign="bottom" align="left">
							<button id="btnCSFp1" name="btnCSF1" class="" onclick="" type="submit" style="margin-left: 4px; height: 30px; width: 82px; cursor: pointer; font:bold 12px Arial; display:;">
							  	         CSF p1</button></td>');
		...
		$smarty->assign('sBtnCF2Part3', '<td width="10" valign="bottom" align="left">
        								<button id="btnCF2Part3" name="btnCF2Part3" onclick="showCF2Part3();" type="submit" style="margin-left: 4px; height: 30px; width:80px; cursor: pointer; font:bold 12px Arial; display:none;">
        								  	         Page 2</button></td>');
		$smarty->assign('sBtnCF2Part4', '<td width="10" valign="bottom" align="left">
        								<button id="btnCF2Part4" name="btnCF2Part4" onclick="showCF2Part4();" type="submit" style="margin-left: 4px; width: 110px; height: 30px; cursor: pointer; font:bold 12px Arial; display:none;">
        								  	         CF2 (blank)</button></td>');

}else /*if (validarea($_SESSION['sess_permission'],1))*/ {
        $canDelete = $smarty->assign('sBtnDelete', '<td width="8" valign="bottom" align="left"><button id="btnDelete" name="btnDelete" class="" type="submit" style="margin-left: 4px;  height: 30px; width: 90px; cursor: pointer; font:bold 12px Arial;">
        								  	         Delete</button></td>');
			        // $smarty->assign('sBtnPrintOld', '<td width="10" valign="bottom" align="left"><button onclick="js_btnHandler_Old()" id="btnPrintOld" name="btnPrintOld" class="" type="submit" style="height: 30px; width: 100px; margin-left: 4px; cursor: pointer; color:#000; font:bold 12px Arial;">
			        // 										   	 Print Old</button></td>');
        			...
        			//added by art 1/10/2014
        			  $smarty->assign('sBtnPrevPackage', '<button id="btnPrevPack" name="btnPrevPack" class="PrevPack" type="submit" style="margin-left: 4px; margin-right: 4px; height: 30px; width: 170px; cursor: pointer; font:bold 12px Arial;">
        									Previous Package</button>');
			        ...
			        # END Jeff ---
        			 ...
        			 $smarty->assign('sBtnCF2Part3', '<td width="10" valign="bottom" align="left">
        								<button id="btnCF2Part3" name="btnCF2Part3" onclick="showCF2Part3();" type="submit" style="margin-left: 4px; height: 30px; width:80px; cursor: pointer; font:bold 12px Arial;">
        								  	         Page 2</button></td>');
        			 //end by art
}/*else {
...
$smarty->assign('sBtnAddAccommodation', '<span style="padding:12px"><button class="" style="font:bold 12px Arial; cursor:pointer"'.($_GET['nr'] == '' ? "" : " disabled").' id="btnaccommodation">Additional Accommodation</button></span>');
...
$smarty->assign('sBirthDate','<input class="segInput" id="birthdate" name="birthdate" type="text" size="15" value="'.strftime("%b %d, %Y", strtotime($birthdate)).'" style="font:bold 12px Arial; float;left;" readOnly >');
...
ob_start();
?>
<input type="hidden" id="updateCaseTypePermission" name="updateCaseTypePermission" value="<?= $updateCaseTypePermission ?>" /><!-- added by Nick 05-27-2014 -->
...
<input type="hidden" id="hospital_discount" name="hospital_discount" value=""/>
<input type="hidden" id="pf_discount" name="pf_discount" value=""/>
<?php
