...
*/
  ...
  function Header() {
    ...
    $this->Image($root_path.'gui/img/logos/dmhi_logo.jpg',55,3,20);
  ...
  $sql = " SELECT
            CONCAT(IFNULL(p.name_last,''),IFNULL(CONCAT(', ', p.name_first),''),IFNULL(CONCAT(' ', p.suffix),''),IFNULL(CONCAT(' ', p.name_middle),'')) AS patient_name, w.ward_id AS Ward,
