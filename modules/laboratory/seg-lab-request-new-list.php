...
function jsRequest(sub_dept_nr,No,refno, name, req_date, urgency, or_no, labstatus, paid, repeat, encounter_nr, pid, age, sex, location, enctype, is_cash, with_res,isrepeat, labRequestDetail){
		...
		if (dTable=document.getElementById('Ttab'+sub_dept_nr)) {
				...
				if (refno) {
						...
						toolTipText = labRequestDetail;

						toolTipTextHandler = ' onMouseOver="return overlib($(\'toolTipText'+refno+'\').value, CAPTION,\'Details\', TEXTPADDING, 8, CAPTIONPADDING, 4, TEXTFONTCLASS, \'oltxt\', CAPTIONFONTCLASS, \'olcap\', WIDTH, 400,FGCLASS,\'olfgjustify\',FGCOLOR, \'#bbddff\');" onmouseout="nd();"';

						donerow='<td '+toolTipTextHandler+' align="center"><a href="javascript:void(0);" '+donelink+'<img src="../../images/edit.gif" border="0"></a></td>';
