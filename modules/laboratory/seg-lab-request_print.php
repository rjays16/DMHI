...
//added by daryl
    ...
    if ($iflabwalk > 0){
                ...
                $request_name = $getwalk['name_last'].", ".$getwalk['name_first'].' '.$person['suffix']." ".$middlename;
             ...
             if ($middlename)
                ...
                $request_name = $person['name_last'].", ".$person['name_first'].' '.$person['suffix']." ".$middlename;
                $request_name = ucwords(strtolower($request_name));
                $request_name = htmlspecialchars($request_name);
            ...
            $this->SetFont("Arial","B","12");
            $this->Cell(25,4,$ssage,$borderNo,$newLineNo,'L');
            $this->SetFont("Arial","","8");
