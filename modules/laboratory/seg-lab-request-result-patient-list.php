...
function viewLabResult(refno,code,pid,group_id){     
	...
	window.open("../../modules/laboratory/reports/lab_result_report.php?pid="+pid+"&refno="+refno+"&group_id="+group_id+"&service_code="+code,"viewPatientResult","left=150, top=100, width=620,height=440,menubar=no,resizable=yes,scrollbars=yes");
}
...
function addResultList(listID, service_name, service, req_date, group_id, refno) {
	...
	if (list) {
		...
		if (service) {
			...
			icon_result = '<a href="javascript:void(0);" onClick=viewLabResult(\''+refno+'\',\''+service+'\',\''+pid+'\',\''+group_id+'\');><img src="../../images/cashier_view_red.gif" border="0" title="Click for the Result"></a>';
	...
	<div id="tabFpanel">
		<table border="0" cellspacing="2" cellpadding="2" width="99%" align="center">
			...
			<tr>
				...
				<td class="segPanel"><?=mb_strtoupper($personInfo['name_last']).", ".mb_strtoupper($personInfo['name_first']).' '.mb_strtoupper($personInfo['suffix'])." ".mb_strtoupper($personInfo['name_middle'])?></td>
			</tr>
			<tr>
