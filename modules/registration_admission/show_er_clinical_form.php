<?php
	...
	*/
	...
	$pdf->Image('image/dmhi_logo.jpg',170,7,20,20);
	//end art
	...
	//added by art 01/18/2014
	// $pdf->SetFont('Arial','B',12);
	// $pdf->Cell(0,6,  "DMHI-F-MRI-10A", "",0, 'R');
	//end art
	...
	$pid2[0] = 0;
	$pdf->SetFont('Arial','B',$fontSizeHeading);
	$pdf->Cell(0,4	,'HRN : '.$pid2,"$border2",0,'R');
	//end
...
$sage_ = $get_age;
	...
	*/
	...
	$pdf->SetFont('Arial','I',$fontSizeLabel);
	$pdf->Cell(64,4,'Data Furnished By',"",0,'L');
	
	$pdf->Cell(63,4,'Signature of Informant',"",0,'L');
