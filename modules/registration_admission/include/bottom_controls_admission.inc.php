...
<?php }
		...
		?>		<a><img id="select-enc" onmouseout="nd();" onclick="return overlib( OLiframeContent('../../modules/registration_admission/seg-reg-company-tray.php?encounter_nr=<?= $HTTP_SESSION_VARS['sess_en']?>&pid=<?= $HTTP_SESSION_VARS['sess_pid']?>&frombilling=0', 800, 400, 'fSelEnc', 1, 'auto'), WIDTH,800, TEXTPADDING,0, BORDER,0, STICKY, SCROLL, CLOSECLICK, MODAL, CLOSETEXT, '<img src=../..//images/close.gif border=0 >', CAPTIONPADDING,4, CAPTION,'Patient Admission History', MIDX,0, MIDY,0, STATUS,'Add Insurance Detail');" style="cursor: pointer;" title="Show companies"  name="select-ins" type="image" <?php echo createLDImgSrc($root_path,'btn_comp.gif','0','top') ?> /></a> <!-- added by mai 07-07-2014 -->