    ...
    <div id="tabFpanel">
        <table border="0" cellspacing="2" cellpadding="2" width="100%" align="center">
            <tr>
                ...
                <td class="segPanel"><?=mb_strtoupper($personInfo['name_last']).", ".mb_strtoupper($personInfo['name_first'])." ".mb_strtoupper($personInfo['name_middle']).' '.mb_strtoupper($personInfo['suffix'])?> (<?=$personInfo['pid']?>)</td>
            </tr>
        </table>
    </div>
</div>
