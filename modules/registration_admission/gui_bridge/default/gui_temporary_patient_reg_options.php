...
echo "<a href=\"javascript:void(0);\" onclick=\"viewCertMed($encounter_nr);\">Medical Certificate</a>";
?>
				</FONT>
			</TD>
		</TR>
                 ...
                 <tr>
                        <td align=center><img <?php echo createComIcon($root_path,'folder_page.png','0'); ?>>&nbsp;</td>
                             <td vAlign=top >
                                <font face="Verdana,Helvetica,Arial" size=2>
<?php
   echo "<a href=\"javascript:void(0);\" onclick=\"ConfinementHistory(".$encounter_nr.");\">History of Confinement</a>";
