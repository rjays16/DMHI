...
if (($is_doctor)||($allow_labresult_read)||($allow_labresult)||($allow_radioresult)|| ($allow_radioresult_read)){
	if (($allow_labresult_read)||($allow_labresult)){
		...
		// #bloodbank
			...
			$TP_manual_limit_icon = '<img '.createComIcon($root_path,'document_post.gif','0').'>';
			$TP_manual_limit = "<a href=\"javascript:void(0);\" onclick=\"ManualCoverage();\" onmouseout=\"nd();\">Set Coverage</a>";
		
			$confinement_icon = '<img '.createComIcon($root_path,'hfolder.gif','0').'>';
			$set_confinement = "<a href=\"javascript:void(0);\" onclick=\"set_confinement();\" onmouseout=\"nd();\">Set Confinement</a>";
