...
switch($table)
{
    case 'care_person':  $sql="SELECT name_last AS \"LastName\", name_first AS \"FirstName\", history, suffix AS \"Suffix\" FROM care_person WHERE pid='$pid'";
		break;
    case 'care_encounter':  $sql=$sql="SELECT p.name_last AS  \"LastName\", p.name_first AS  \"FirstName\", p.suffix AS  \"Suffix\",
     e.history
...
<body onBlur="window.close()"><font face=arial>
 ...
 <font size=3 color="#000099"><b><?php echo $history['LastName']; ?>, <?php echo $history['FirstName']." ".$history['Suffix']; ?></b></font>
...
<script type="text/javascript">
	function viewDBHistory(){
		...
		window.open("<?=$root_path?>modules/registration_admission/record_history_pdf.php?&table="+table+"&pid="+pid+"&showBrowser=1","viewDBHistory","width=620,height=440,menubar=no,resizable=yes,scrollbars=yes")
