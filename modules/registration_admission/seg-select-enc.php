...
function selectWalkin(reg) {
	...
	if (var_history)
		...
		//if (var_ward_nr)
			//window.parent.$(var_ward_nr).value=0;
...
?>
	...
	<ul id="cashier-tabs" class="segTab" style="padding-left:10px">
		...
		<li segTab="tab1" onclick="tabClick(this)">
		...
		<div id="tab1" class="tabFrame" style="display:none;padding:5px" >
			...
			<table width="100%" cellpadding="2" cellspacing="0" border="0" style="font-family:Arial, Helvetica, sans-serif">
				...
				<tr valign="top">
					...
					<td align="left" valign="middle" nowrap="nowrap">
						<input class="segInput" name="date_birth" id="date_birth" type="text" size="10" maxlength=10 value="" onKeyPress="return keyPressHandler(event,1);" onblur="getAge(); IsValidDate(this,'MM/dd/yyyy');" onKeyUp="setDate(this,'MM/dd/yyyy','en')" onfocus="this.select();">
