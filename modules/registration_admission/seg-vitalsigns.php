        ...
        <tbody>
            ...
            <tr align="center">
                <td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d">
                    <table width="95%" border="0" cellpadding="2" cellspacing="2" style="font:bold 12px Arial; color:#2d2d2d; margin:1%">
                        <tr>
                            <td width="50%">
                                <table>
                                    <tr>
                                        ...
                                        <td width="50%">
                                            <input class="segInput" id="vital_bp" name="vital_bp" type="text" size="15" style="padding-left:4px;font:bold 14px Arial" value="" onblur=""/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="50%">
                            ...
                            <td width="45%" align="right" valign="top">         
                                <table>
                                    <tr>
                                        <td>
                                           <span>Diagnosis (VERBATIM)</span>  
                                        <td>
                                    </tr>
                                    <tr><td>
                                        <textarea name="er_opd_diagnosis" id="er_opd_diagnosis" cols="30" rows="3" wrap="VIRTUAL"></textarea>
                                    </td></tr>
                                </table>    
                            </td>
                        </tr>
