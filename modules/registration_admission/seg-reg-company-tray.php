...
function startAJAXSearch(searchID, page) {
	...
	var enc_nr = getPageParam('encounter_nr');
	if (searchEL) {
		searchEL.style.color = "#0000ff";
		if (AJAXTimerID) clearTimeout(AJAXTimerID);
		$("ajax-loading").style.display = "";
		AJAXTimerID = setTimeout("xajax_populateCompany('"+searchID+"','"+searchEL.value+"',"+enc_nr+","+page+")",100);
...
<script type="text/javascript" src="<?=$root_path?>modules/registration_admission/js/reg-company-tray-gui.js?t=<?=time()?>"></script>
						...
						<table id="product-list" class="segList" cellpadding="1" cellspacing="1" width="100%">
							<thead>
								...
								<tr>
									...
									<th width="30%">Charge to company</th>
									<th width="20%">Maximum Charge</th>
									<!-- <th width="10%"></th> -->
								</tr>
							</thead>
							<tbody>
