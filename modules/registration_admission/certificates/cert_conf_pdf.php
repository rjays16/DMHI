...
// //added by daryl
	 $sage_  = specific_age($encInfo['date_birth']);  
	 #ended by daryl
...
$pdf->SetFont($fontStyle,"",$fontSizeText);
//edited by daryl
$pdf->MultiCell(180, 6,'       This is to certify that '.trim(stripslashes(strtoupper($name_last))).", ".trim(stripslashes(strtoupper($name_first)))." ".trim(stripslashes(strtoupper($suffix))).' '.trim(stripslashes(strtoupper($name_middle))).
...
$pdf->MultiCell(180, 6,strtoupper($confCertInfo['admitting_diagnosis']) ,0,'L',0);
...
$pdf->Ln(8);
$pdf->Cell(40,3, '', "",0,'L');
$pdf->Cell(40,3, 'Operation Performed :  ______________________________', $border2,0,'L');
$pdf->Cell(30,3, '', "",0,'L');
$pdf->Cell(10,3, mb_strtoupper($confCertInfo['operation_performed']), $border2,1,'L');

$pdf->Ln(2);
$pdf->Cell(40,3, '', "",0,'L');
$pdf->Cell(40,3, 'Remarks :              ______________________________', $border2,0,'L');
$pdf->Cell(30,3, '', "",0,'L');
$pdf->Cell(10,3, mb_strtoupper($confCertInfo['purpose']), $border2,1,'L');

$pdf->Ln(2);
$pdf->Cell(40,3, '', "",0,'L');
$pdf->Cell(40,3, 'Requested By :         ______________________________', $border2,0,'L');
$pdf->Cell(30,3, '', "",0,'L');
$pdf->Cell(10,3, ucwords(mb_strtolower($confCertInfo['requested_by'])), $border2,1,'L');

$pdf->Ln(2);
$pdf->Cell(40,3, '', "",0,'L');
$pdf->Cell(40,3, 'Relation to patient :  ______________________________', $border2,0,'L');
$pdf->Cell(30,3, '', "",0,'L');
$pdf->Cell(10,3, ucwords(mb_strtolower($confCertInfo['relation_to_patient'])), $border2,1,'L');
...
if ($confCertInfo['is_doc_sig']){
	...
	$pdf->Cell(10,6,$confCertInfo['lic_no'],"",0,"L");
	$pdf->Ln(5);
	$pdf->Cell(116,6,'',"",0,"");
