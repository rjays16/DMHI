...
if(isset($_POST['mode'])){
	switch($_POST['mode']){
		case 'save':
			...
			echo	$obj_deathCert->saveOtherInfo($HTTP_POST_VARS);
			
				// echo $HTTP_POST_VARS['day']."ssssss";
		...
		case 'update':
			...
			if($obj_deathCert->updateDeathCertificateInfoFromArray($HTTP_POST_VARS)){
				...
				$HTTP_POST_VARS['sec'] = $HTTP_POST_VARS['sec'];
				$HTTP_POST_VARS['minutes'] = $HTTP_POST_VARS['minutes'];
				$HTTP_POST_VARS['hours'] = $HTTP_POST_VARS['hours'];
				$HTTP_POST_VARS['death_days'] = $HTTP_POST_VARS['death_days'];
				$HTTP_POST_VARS['death_months'] = $HTTP_POST_VARS['death_months'];
				$HTTP_POST_VARS['death_age'] = $HTTP_POST_VARS['death_age'];
			
				$person_obj->updatePersonInfo($pid, $HTTP_POST_VARS);
				$obj_deathCert->saveOtherInfo($HTTP_POST_VARS);
...
<?php
	if (!$deathCertInfo || empty($deathCertInfo)){
		...
		echo '			<input type="button" name="Print" value="Print Epson" onClick="printDeathCertNew_epson(\''.$pid.'\')">'."\n &nbsp; &nbsp;";
		echo '			<input type="button" name="Print" value="Print Kyocera" onClick="printDeathCertNew_kyocera(\''.$pid.'\')">'."\n &nbsp; &nbsp;";#added by daryl
		 ...
		 <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#A0C2DA">
			...
			<tr>
			 ...
			 <td width="26%" align="center" valign="top" bgcolor="#F9FFFB"><span class="style2">Given Name </span><br />
				<input type="text" name="name_first" id="name_first" size="30" value="<?= ucwords(strtolower($name_first)).' '.ucwords(strtolower($suffix)) ?>" />
			 </td>
		...
		<td width="53%" valign="top" bgcolor="#F9FFFB"><table width="100%" border="0" cellspacing="2" cellpadding="0">
		 <tr>
			...
			<td width="35%" bgcolor="#D5E3EE" class="style2">c. under 1 day </td>
			 ...
			 <tr>
			 	<?php 
			 	if (($age_at_death == "") || empty($age_at_death)){
			 		$ages_ = number_format(floor($ageYear));
			 	}else{
			 		$ages_ = $age_at_death;
			 	}
			 	?>
		...
		<!--	<input name="death_age" type="text" class="style2" id="death_age" maxlength="3" size="5"
			...
			<td bgcolor="#F9FFFB" class="style2"><table width="100%" border="0" cellpadding="2" cellspacing="2">
				...
				<td width="114" align="center" valign="top" class="style2"> Months <br />
				 <input name="death_months" type="text" class="style2" id="death_months" size="5"  value="<?= $death_month ?>" />
				</td>
				<td width="84" align="center" valign="top" class="style2"> Days <br />
				 <input name="death_days" type="text" class="style2" id="death_days" size="5"  value="<?= $death_day ?>" />
				</td>
			 </tr>
			</table></td>
			<td bgcolor="#F9FFFB" class="style2"><table width="100%" border="0" cellpadding="2" cellspacing="2">
			 <tr>
				<td align="center" valign="top" class="style2"> Hrs <br />
					...
					<!--<input name="hours" type="text" class="style2" id="hours" size="3" onblur="trimString(this); checkTime(this);" <?php if (($ageYear<1)&&($ageMonth<1)&&($ageDay<1)){  echo 'value="'.$death_hour.'"'; }else{ echo " "; } ?> />-->
					<input name="hours" type="text" class="style2" id="hours" size="3" onblur="trimString(this); checkTime(this);" <?php   echo 'value="'.$death_hour.'"'; ?> />
				</td>
				<td align="center" valign="top" class="style2"> Min <br />
					...
					<!--<input name="minutes" type="text" class="style2" id="minutes" size="3" onblur="trimString(this); checkTime(this);" <?php if (($ageYear<1)&&($ageMonth<1)&&($ageDay<1)){  echo 'value="'.$death_min.'"'; }else{ echo " "; }?> />-->
					<input name="minutes" type="text" class="style2" id="minutes" size="3" onblur="trimString(this); checkTime(this);" <?php  echo 'value="'.$death_min.'"'; ?> />
				</td>
				<td align="center" valign="top" class="style2"> Sec <br />
					...
					<!-- <input name="sec" type="text" class="style2" id="sec" size="3" onblur="trimString(this); checkTime(this);" <?php if (($ageYear<1)&&($ageMonth<1)&&($ageDay<1)){  echo 'value="'.$death_sec.'"'; }else{ echo " "; }?> /> -->
					<input name="sec" type="text" class="style2" id="sec" size="3" onblur="trimString(this); checkTime(this);" <?php  echo 'value="'.$death_sec.'"'; ?> />
				</td>
			 </tr>
				</table></td>
			 </tr>
...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="1">
 ...
 <tbody id="Row1" <?= $Row1Style ?>>
	...
	<!-- START FOR CAUSES OF DEATH FOR AGES 0 TO 7 DAYS -->
			 <tr>
			<td colspan="2"><table width="100%" bgcolor="#A0C2DA" border="0" cellpadding="2" cellspacing="1" <?= $Row1Style ?>>
			 <tr bgcolor="#FFDDFF">
			<td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="2" cellspacing="0">
			 <tr>
				<td colspan="2" bgcolor="#D5E3EE">
				 <span class="style5">&nbsp;19a. &nbsp; CAUSES OF DEATH </span>
				</td>
			 </tr>
			 <tr>
...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#A0C2DA" <?= $Row2Style ?>>
 <tr>
...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#A0C2DA" style="display:none">
   <tr>
	 ...
	 <tr>
		<td bgcolor="#F9FFFB" class="style2">
				<input name="corpse_disposal_tmp" id="corpse_disposal_tmp" type="radio" onclick="typeOfDisposal(this);" value="3" <?php if($corpse_disposal_tmp == '3') echo "checked";?> />
						3. Others (Specify)
				<input  type="text" class="style2" name="corpse_disposal_others" id="corpse_disposal_others" onblur="trimString(this); $('corpse_disposal').value= '3 - '+this.value;" value="<?php if ($corpse_disposal_tmp == '3') echo $corpse_others; ?>" />
		</td>
	 </tr>
	 <tr>
		<td bgcolor="#F9FFFB" class="style2">&nbsp;</td>
...
<!-- COMMENTED BY JASPER	 <tr>
     ...
     <tr>
             ...
             was attended by
             <input type="text" id="late_attended_by" name="late_attended_by" size="90" value="<?=$late_attended_by?>" <?php if (!($late_is_attended=='1')) echo ""; ?> />
             </td>
     </tr>
     <tr>
         <td bgcolor="#F9FFFB">
