...
//			$('f_fullname').value = $F('f_name_first')+" "+$F('f_name_middle')+" "+$F('f_name_last');
	...
	//--------------------
//edited by daryl
	function printBirthCert_kyocera(id){
		if (id==0)
			id="";
		...
		//}else{
			window.open("cert_birth_pdf_jasper_kyocera.php?pid="+id,"birthCertificate","modal, width=900,height=700,menubar=no,resizable=yes,scrollbars=no");
		//}

	}/* end of function printBirthCert */

//added by daryl
	function printBirthCert_epson(id){
		if (id==0)
			id="";
		...
		//	window.showModalDialog("cert_birth_pdf.php?id="+id,"width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
		//}else{
			window.open("cert_birth_pdf_jasper_epson.php?pid="+id,"birthCertificate","modal, width=900,height=700,menubar=no,resizable=yes,scrollbars=no");
		//}
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<?php
			if (!$birthCertInfo || empty($birthCertInfo)){
				...
				echo '			<input type="button" name="Print_Epson" value="Print Epson" onClick="printBirthCert_epson(\''.$pid.'\')">'."\n &nbsp; &nbsp;";#added by daryl
				echo '			<input type="button" name="Print_Kyocera" value="Print Kyocera" onClick="printBirthCert_kyocera(\''.$pid.'\')">'."\n &nbsp; &nbsp;";
				#added by VAN 05-26-08
								...
								<td height="468" align="center" bgcolor="#F9FFFB"> <br />
										<table width="90%" border="0" cellspacing="0" cellpadding="0">
											<tr>
											 ...
											 -->
																	<input type="text" name="name_first" id="name_first" size="30" value="<?= ucwords(strtolower(stripslashes($name_first))).' '.ucwords(strtolower(stripslashes($suffix))) ?>" onblur="UpdateBabyinLate();" />
															</td>
...
on the date stated above. </span></td>
							...
							<?php
										...
										$doctor_obj = $pers_obj->getDoctors(1," AND d.nr IN (214) ");
										/*
            ...
            <tr> 
                  ...
                  <!--   <?php
                        ...
                        if (empty($encoder_name)){
                            ...
                            if (!(in_array( $encoder_name, (array)$sig_array)))
                                $add_option = '<option value="'. $_SESSION['sess_user_name'].'" selected>'. $_SESSION['sess_user_name']."</option> \n";
				...
				*/
                ...
                <td bgcolor="#FFF3EC" width="85%">
                    ...
                    <select id="encoder_name" name="encoder_name">
                        <!--<option value="0">-Select a Signatory-</option>-->
                        <?php
                            # Retrieve record set of all signatories
                            // echo $add_option;
                        
                                echo '<option value="'. $_SESSION['sess_user_name'].'" >'. $_SESSION['sess_user_name']."</option> \n";
