...
$report = 'BirthCertificate_kyocera';
global $db;
    $newObj = new Report;
...
#data
$data[0]['birth_place_prov'] = " ";
$data[0]['birth_place_mun'] = " ";
$data[0]['registry_nr'] = " ";
$data[0]['name_first'] = " ";
$data[0]['name_middle'] = " ";
$data[0]['name_last'] = " ";
...
$data[0]['f_residence_place'] = " ";
$data[0]['f_residence_place'] = " ";
$data[0]['parent_marriage_month'] = " ";
$data[0]['parent_marriage_day'] = " ";
$data[0]['parent_marriage_year'] = " ";
...
$data[0]['is_hilot'] = " ";
$data[0]['is_other'] = " ";
$data[0]['is_other_name'] = " ";
$data[0]['birth_time'] = " ";
$data[0]['birth_time_am'] = " ";
$data[0]['birth_time_pm'] = " ";
$data[0]['non_resident_status'] = " ";
$data[0]['attendant_name'] = " ";
...
$data[0]['receiver_title'] = " ";
$data[0]['receiver_date_sign'] = " ";
...
$data[0]['late_affiant_address'] = " ";
$data[0]['late_1'] = " ";
$data[0]['late_2'] = " ";
$data[0]['late_fullname_1'] = " ";
$data[0]['late_date_birth_1'] = " ";
$data[0]['late_2'] = " ";
$data[0]['late_1'] = " ";
$data[0]['late_fullname_2'] = " ";
$data[0]['late_birth_place_1'] = " ";
$data[0]['late_birth_place_2'] = " "; 
$data[0]['late_birth_place_2'] = " "; 
$data[0]['late_date_birth_2'] = " ";
$data[0]['late_attendant'] = " ";
$data[0]['late_attendant_address'] = " ";
$data[0]['late_baby_citizenship'] = " ";
$data[0]['late_not_married'] = " ";; 
$data[0]['late_married'] = " ";;
$data[0]['late_f_fullname'] = " "; 
$data[0]['late_married'] = " ";
$data[0]['late_not_married'] = " "; 
$data[0]['late_parent_marriage_place'] = " ";
$data[0]['late_parent_marriage_date'] = " ";
$data[0]['late_reason'] = " ";
$data[0]['late_husband'] = " ";
$data[0]['late_relationship'] = " ";
$data[0]['late_affiant_date_ack_day'] = " ";
$data[0]['late_affiant_date_ack_monthyr'] = " ";
$data[0]['late_affiant_place2'] = " ";
$data[0]['late_affiant_name'] = " ";
$data[0]['late_officer_place_sign'] = " ";
$data[0]['late_affiant_com_tax_nr'] = " ";
$data[0]['late_officer_date_sign_day'] = " ";
$data[0]['late_officer_date_sign_monthyr'] = " ";
$data[0]['late_affiant_com_tax_date'] =  " ";
$data[0]['late_affiant_place'] =  " ";
$data[0]['late_affiant_com_tax_place'] =  " ";
...
if ($birthCertInfo){
    ...
    $data[0]['suffix'] = mb_strtoupper(stripslashes($suffix))." ";
    #SEX
    if ($sex=='m')
        $gender = "MALE";
    elseif ($sex=='f')
    ...
    $data[0]['birthMonth'] = mb_strtoupper($birthMonth)." ";
    ...
    #BIRTH ORDER
    $data[0]['birth_order'] = mb_strtoupper(seg_ucwords($birth_order))." ";
    ...
    /*if (!empty($m_address) && !empty($m_residence_brgy)){
        $m_address = $m_address.", ".seg_ucwords(trim($brgy['brgy_name']));
    }else{
        $m_address = $m_address." ".seg_ucwords(trim($brgy['brgy_name']));
    }*/
    ...
    if ($m_residence_country=='PH')
        $data[0]['m_residence_place'] = mb_strtoupper($m_address.$m_country)." ";
    else{
        #barangay, municipality and province is BLANK
        $m_address2 = mb_strtoupper(trim($m_residence_basic));
        ...
        $data[0]['m_residence_place'] = mb_strtoupper($m_address2.$m_country2)." ";
    }    
    ...
    $data[0]['f_citizenship'] = mb_strtoupper(seg_ucwords($f_citizenship));
    #RELIGION
    if (($f_religion_name=="Not Applicable")||($f_religion_name=="Not Indicated"))
        $f_religion_name="";
    $data[0]['f_religion'] = mb_strtoupper($f_religion_name)." ";
    
    #OCCUPATION (FATHER) 
    if (($f_occupation_name=="Not Applicable")||($f_occupation_name=="Not Indicated"))
    $data[0]['f_occupation'] = " ";#added by daryl

    $data[0]['f_occupation'] = $f_occupation_name." ";
   ...
   #RESIDENCE
   $f_address = mb_strtoupper(trim($f_residence_basic));
   ...
   if (($f_name_first=="N/A") || ($f_name_first=="N/A")){
       ...
       if ($f_address){
        ...
        /*if (!empty($f_address) && !empty($f_residence_brgy)){
            $f_address = $f_address.", ".seg_ucwords(trim($brgy['brgy_name']));
        }else{
            $f_address = $f_address." ".seg_ucwords(trim($brgy['brgy_name']));
        }*/
        
        if (!empty($f_address) && !empty($f_residence_mun)){
            $f_address = $f_address.", ".seg_ucwords(trim($mun['mun_name']));
        }else{
            $f_address = $f_address." ".seg_ucwords(trim($mun['mun_name']));
        }
        ...
        if(stristr($mun['mun_name'], 'city') === FALSE){
            if (!empty($f_address)){
                $f_address = $f_address.", ".seg_ucwords(trim($prov['prov_name']));
            }else{
                $f_address = $f_address." ".seg_ucwords(trim($prov['prov_name']));
            }
        }   
        ...
        if ($f_residence_country=='PH')
            $data[0]['f_residence_place'] = mb_strtoupper($f_address.$f_country)." ";
        else{
            #barangay, municipality and province is BLANK
            $f_address2 = mb_strtoupper(trim($f_residence_basic));
            
            if (($f_address2)&&(trim($country['country_name'])))
                $f_country2 = ", ".seg_ucwords(trim($country['country_name'])); 
            else
                $f_country2 = mb_strtoupper(seg_ucwords(trim($country['country_name'])));     
                     
            $data[0]['f_residence_place'] = mb_strtoupper($f_address2.$f_country2)." ";
        }
    ...
    $data[0]['parent_marriage_month'] = mb_strtoupper($parent_marriage_month)." ";
    $data[0]['parent_marriage_day'] = $parent_marriage_day." ";
    $data[0]['parent_marriage_year'] = $parent_marriage_year." ";
    $data[0]['parent_marriage_place'] = mb_strtoupper($parent_marriage_place)." ";
    ...
    $data[0]['attendant_address'] = mb_strtoupper($attendant_address)." ";
    ...
    $data[0]['informant_address'] = mb_strtoupper(trim($informant_address))." ";
    ...
    $data[0]['receiver_title'] = mb_strtoupper($receiver_title)." ";
    ...
    $data[0]['receiver_date_sign'] = mb_strtoupper($receiver_date_sign)." ";  
    ...
    if ($is_married!=1){
        ...
        $data[0]['ack_date_month'] = mb_strtoupper($officerMonthName)." ";
        ...
        $data[0]['ack_f_com_tax_date'] = mb_strtoupper($f_com_tax_date)." ";
        $data[0]['ack_f_com_tax_place'] = mb_strtoupper($officer_place_sign)." ";
        $data[0]['ack_officer_name'] = mb_strtoupper($officer_name)." ";
        $data[0]['ack_officer_title'] = mb_strtoupper($officer_title)." ";
        $data[0]['ack_officer_address'] = mb_strtoupper($officer_address)." ";    
    }    
    ...
    if ($is_late_reg=='1'){
        ...
        $data[0]['late_affiant_address'] = mb_strtoupper($late_affiant_address)." ";
        ...
        if ($is_subject_person){
            ...
            if (strlen($birthplace) > 15){
                ...
                $data[0]['late_birth_place_2'] = mb_strtoupper($birthplace)." "; 
            
            $data[0]['late_date_birth_2'] = mb_strtoupper($bdate)." ";
        }    
        
        $data[0]['late_attendant'] = mb_strtoupper($doctor_name)." ";
        $data[0]['late_attendant_address'] = mb_strtoupper($doctor_address)." ";
        
        $country = $address_country->getCountryInfo($late_baby_citizenship);
        $data[0]['late_baby_citizenship'] = mb_strtoupper($country['country_name'])." ";
        #uncommented
        if ($is_married!=1){
            ...
            $data[0]['late_not_married'] = ''." "; 
            $data[0]['late_parent_marriage_place'] = mb_strtoupper($parent_marriage_place)." ";
            $data[0]['late_parent_marriage_date'] = mb_strtoupper(date("F d, Y",strtotime($parent_marriage_date)))." ";
        }    
        ...
        $data[0]['late_affiant_date_ack_day'] = mb_strtoupper($late_affiant_date_ack_day)." ";
        $data[0]['late_affiant_date_ack_monthyr'] = mb_strtoupper($late_affiant_date_ack_monthyr)." ";
        $data[0]['late_affiant_place2'] = mb_strtoupper($affiant_com_tax_place2)." ";
        $data[0]['late_affiant_name'] = mb_strtoupper($late_affiant_name)." ";
        
        $data[0]['late_officer_place_sign'] = mb_strtoupper($late_officer_place_sign)." ";
        $data[0]['late_affiant_com_tax_nr'] = mb_strtoupper($affiant_com_tax_nr)." ";
        ...
        $data[0]['late_officer_date_sign_day'] = mb_strtoupper($late_officer_date_sign_day)." ";
        $data[0]['late_officer_date_sign_monthyr'] = mb_strtoupper($late_officer_date_sign_monthyr)." ";
        $data[0]['late_affiant_com_tax_date'] = mb_strtoupper($affiant_com_tax_date)." ";
        $data[0]['late_affiant_place'] = mb_strtoupper($affiant_com_tax_place)." ";
        $data[0]['late_affiant_com_tax_place'] = mb_strtoupper($affiant_com_tax_place)." ";
        $data[0]['late_officer_name'] = mb_strtoupper($late_officer_name)." ";
        $data[0]['late_officer_title'] = mb_strtoupper($late_officer_title)." ";
        $data[0]['late_officer_address'] = mb_strtoupper($late_officer_address)." ";
