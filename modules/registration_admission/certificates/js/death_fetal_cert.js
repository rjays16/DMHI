...
function printFetalDeathCert(id){
	...
	if (window.showModalDialog){  //for IE
		window.showModalDialog("cert_death_fetal_pdf_jasper.php?id="+id,"width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
	}else{
		window.open("cert_death_fetal_pdf_jasper.php?id="+id,"FetalDeathCertificate","modal, width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
	}
