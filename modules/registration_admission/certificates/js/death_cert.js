//--- with modifications by pet from previous death_cert.js started by burn & vanessa ---
	...
	*/
    ...
    function printDeathCertNew_kyocera(id){
        if (id==0)
            id="";
        if (window.showModalDialog){  //for IE
            window.showModalDialog("cert_death_pdf_jasper_kyocera.php?id="+id,"width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
        }else{
            window.open("cert_death_pdf_jasper_kyocera.php?id="+id,"deathCertificate kyoce","modal, width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
        }
    }// end of function printDeathCert

    //added by jasper 01/09/2013
    function printDeathCertNew_epson(id){
        if (id==0)
            id="";
        if (window.showModalDialog){  //for IE
            window.showModalDialog("cert_death_pdf_jasper_epson.php?id="+id,"width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
        }else{
            window.open("cert_death_pdf_jasper_epson.php?id="+id,"deathCertificate","modal, width=600,height=400,menubar=no,resizable=yes,scrollbars=no");
        }
    }// end of function printDeathCert
