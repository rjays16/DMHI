...
if($is_with_header==1){
    ...
    //Hospital Logo
    //$pdf->Image($root_path.'gui/img/logos/dmhi_logo.jpg',20,5,25,30);
    $pdf->Image($root_path.'gui/img/logos/dmhi_logo.jpg',40,10,20,20);
    $pdf->Image($root_path.'gui/img/logos/dmhi_logo.jpg',150,10,20,20); 
}
