...
$report = 'DeathCertificate_kyocera';
$newObj = new Report;
...
// ECHO $DeathCertInfo['corpse_disposal']."a";exit();
    ...
    $data[0]['suffix'] = strtoupper(mb_strtoupper(stripslashes($suffix)))." ";
    #SEX
    if ($sex=='m')
        $gender = "Male";
    elseif ($sex=='f')
            ...
            if (is_numeric($ageYear) && ($ageYear>=0)){
                if ($ageYear<1){
                    ...
                    if(($ageMonth == 0) && (round($ageDay)<1)){
                        ...
                        $ageMonth = '0'; # set age in months as empty
                        $ageDay = '0'; # set age in days as empty
                    ...
                    $ageYear = '0'; # set age in years as empty
                }else{
                    # above 1 year
   ...
   #added by daryl
    ...
    $data[0]['age_month'] = strtoupper($death_month)." ";
    $data[0]['age_days'] = strtoupper($death_day)." ";
    $data[0]['age_hours'] =strtoupper( $death_hour)." ";
    $data[0]['age_min_sec'] = strtoupper($death_min." ".$death_sec)." ";
    #END OF AGE
    #added by daryl
...
//11. DATE OF BIRTH   not included in the new format
 ...
 if (($ageDay<8) && ($ageDay!="")){
  ...
  $data[0]['cemetery'] = $cemetery_name_address." ";
...
if ($DeathCertInfo['is_late_reg'] == 1){
   ...
   $data[0]['late_officer_address'] = $late_officer_address." ";
          ...
          $data[0]['interval_death_a'] = strtoupper($tmp_death_cause['interval1'])." ";
          $data[0]['interval_death_b'] = strtoupper($tmp_death_cause['interval2'])." ";
          $data[0]['interval_death_c'] = strtoupper($tmp_death_cause['interval3'])." ";
