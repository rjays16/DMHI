        ...
        <table width="100%" class="segPanel">
            ...
            <tr>
                <td width="15%" align="right"><b>Unit Price:</b></td>
                    <!--td align="left"><input style="text-align:right" onblur="trimString(this); genChkDecimal(this,3);" onFocus="this.select();" id="price_add" name="price_add" value="<?=$_GET["price"]?>" size="10"/></td-->
                    <td align="left"><input style="text-align:right" onblur="trimString(this); genChkDecimal(this,3);" onFocus="this.select();" id="price_add" name="price_add" value="<?=$_GET["price"]?>" size="10"/></td>
