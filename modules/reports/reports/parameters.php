<?php
    ...
    if ($row = $objInfo->getAllHospitalInfo()) {
        ...
        $hosp_addr1   = strtoupper($row['addr_no_street']);
    }else {
...
$age_bracket_sum = "SUM(t.male_below1) AS male_below1, 
                    SUM(t.female_below1) AS female_below1, 

                    SUM(t.male_1to4) AS male_1to4, 
                    SUM(t.female_1to4) AS female_1to4, 

                    SUM(t.male_5to9) AS male_5to9, 
                    SUM(t.female_5to9) AS female_5to9, 

                    SUM(t.male_10to14) AS male_10to14, 
                    SUM(t.female_10to14) AS female_10to14, 

                    SUM(t.male_15to19) AS male_15to19, 
                    SUM(t.female_15to19) AS female_15to19, 

                    SUM(t.male_20to24) AS male_20to24, 
                    SUM(t.female_20to24) AS female_20to24, 

                    SUM(t.male_25to29) AS male_25to29, 
                    SUM(t.female_25to29) AS female_25to29,

                    SUM(t.male_30to34) AS male_30to34, 
                    SUM(t.female_30to34) AS female_30to34,

                    SUM(t.male_35to39) AS male_35to39, 
                    SUM(t.female_35to39) AS female_35to39,

                    SUM(t.male_40to44) AS male_40to44, 
                    SUM(t.female_40to44) AS female_40to44,

                    SUM(t.male_45to49) AS male_45to49, 
                    SUM(t.female_45to49) AS female_45to49,

                    SUM(t.male_50to54) AS male_50to54, 
                    SUM(t.female_50to54) AS female_50to54,

                    SUM(t.male_55to59) AS male_55to59, 
                    SUM(t.female_55to59) AS female_55to59,

                    SUM(t.male_60to64) AS male_60to64, 
                    SUM(t.female_60to64) AS female_60to64,

                    SUM(t.male_65to69) AS male_65to69, 
                    SUM(t.female_65to69) AS female_65to69,

                    SUM(t.male_70above) AS male_70above, 
                    SUM(t.female_70above) AS female_70above";
