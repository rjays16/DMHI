...
if ($result) {
		...
		while ($row = $result->FetchRow()) {
				...
				$btns = '<td width="8%" align="center"><div style="float:left;" id="status"><a title="Toggle transmittal status!" href="#">
												...
												</a></div><a title="Edit transmittal!" href="billing-transmittal.php'.URL_APPEND.'&userck='.$userck.'&tr_nr='.$row["transmit_no"].'&from=billing-transmittal-hist&hcare_id='.$nhcare_id.'">
