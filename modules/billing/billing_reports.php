...
<div id="print_params" style="display:none;">
	<table width="100%">
		...
		<tr>
			<td width="25%">Print type:</td>
			<td width="75%">
				<select id="print_type" paramName="print_type" segOption="print_type">
					<option value="Nondetailed">Non-detailed</option>
	...
	$j('#print_params').dialog({
		...
		buttons:{
			Print:function(){
					...
					var rep_script = '';
					var print_type = $('print_type').value;
					var report_type = '';
...
<div style="width:500px">
			...
			<tr>
				<td nowrap="nowrap" align="right" class="segPanel">
					...
					<table name="selOptions" width="100%" border="0" cellpadding="2" cellspacing="0" segOption="acr_daily" style="display:none">
						<tr>
							<td align="right" >Eclaims Status</td>
							<td nowrap="nowrap">
								<select class="segInput" id="acr_daily_etype" name="param" paramName="acr_daily_etype" segOption="acr_daily">
									<option value="Select_All">Select All</option>
									<option value="None_Eclaims">None Eclaims</option>
									<option value="Eclaims_Only">Eclaims Only</option>
								</select>
							</td>
						</tr>
						<tr>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                <select class="segInput" id="acr_daily_orderby" name="param" paramName="formatD" segOption="acr_daily">
					...
					<table name="selOptions" width="100%" border="0" cellpadding="2" cellspacing="0" segOption="acr_monthly" style="display:none">
						<tr>
							<td align="right" >Eclaims Status</td>
							<td nowrap="nowrap">
								<select class="segInput" id="acr_monthly_etype" name="param" paramName="acr_monthly_etype" segOption="acr_monthly">
									<option value="Select_All">Select All</option>
									<option value="None_Eclaims">None Eclaims</option>
									<option value="Eclaims_Only">Eclaims Only</option>
								</select>
 ...
 <tr>
                            <td align="right" >Order by:</td>
                            <td nowrap="nowrap">
                                <select class="segInput" id="acr_monthly_orderby" name="param" paramName="formatD" segOption="acr_monthly">
                                    <option value="ASC">Ascending</option>
                                    <option value="DESC">Descending</option>
                                </select>
                            </td>
						...
						<!--added by daryl-->
							...
							<td nowrap="nowrap">
								<select class="segInput" id="acr_type" name="param" paramName="acr_type" segOption="acr_type">
