...
if ($row = $objInfo->getAllHospitalInfo()) {
  ...
  $row['hospital_name']    = "DAVAO MEDIQUEST HOSPITAL INCORPORATED";
  $row['hosp_addr1']   = "Mac Arthur Highway Lizada Toril Davao City";
}
...
$result = $bill_obj->getSummaryTransmittal($trans_no,$case_type);
// echo $bill_obj->sql;
// exit();
