...
$patient_name = stripslashes(strtoupper($encInfo['name_last'])).', '.stripslashes(strtoupper($encInfo['name_first'])).' '.stripslashes(strtoupper($encInfo['suffix'])).' '.stripslashes(strtoupper($encInfo['name_middle']));
