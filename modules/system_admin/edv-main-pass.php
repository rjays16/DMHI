...
switch($target)
{
	...
	break;
	case 'HolidaysDateCreate':
		$title = "Holidays::Create";
		$allowedarea = array('_a_1_sysad_insurance_manage','_a_1_sysad_Holidays_Dates');
		$fileforward=$root_path."modules/system_admin/seg_holiday_create.php".URL_APPEND;
	break;

	case 'HolidaysDateList':
		$title = "Holidays::List";
		$allowedarea = array('_a_1_sysad_insurance_manage','_a_1_sysad_Holidays_Dates');
		$fileforward = $root_path."modules/system_admin/seg_holiday_list.php".URL_APPEND;
	break;
