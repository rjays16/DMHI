...
function cancelFlag(area, refno, item_code, flag, is_final_bill, is_discharged)
{
	if(flag=="") {
	...
	if (is_final_bill == 1) {
		alert("Cannot cancel request because the bill is final.");
		return false;
	}

	if (is_discharged == 1) {
		alert("Cannot cancel request because the patient is already discharged");
		return false;
	}
