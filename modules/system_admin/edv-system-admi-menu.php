...
$items = array(
  ...
  $LDHolidays => array(
    $LDCreate => "edv-main-pass.php?sid=$sid&lang=$lang&target=HolidaysDateCreate&src=sysadmin",
    $LDList => "edv-main-pass.php?sid=$sid&lang=$lang&target=HolidaysDateList&src=sysadmin"
  ),
  $LDDatabase => array(
