...
$smarty->assign('sSetup', '<select class="segInput" id="service_setup" name="service_setup" style="width:60%" onchange="$(\'selpatient\').disabled=false;$(\'name\').disabled=false;">
                    <option value="ALL">-ALL-</option>
                    <option value="YES">Setup</option>
                    <option value="NO">Not Yet Setup</option>
                    </select>');
