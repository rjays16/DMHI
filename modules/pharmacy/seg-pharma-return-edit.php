...
require $root_path . 'include/care_api_classes/inventory/class_inventory_helper.php';
global $db;
...
if (isset($_POST["submitted"]) && !$_REQUEST['viewonly']) {
    ...
    {
        $qty = $_POST["returned"][$i];
        $itemCode = $_POST["items"][$i];
        $refNo = $_POST["ref"][$i];
        $inventoryHelper->addStock($itemCode, 'IP', $qty, '', $refNo, $refNo);
...
$select_area = '<option value="IP">Pharmacy</option>';
