	...
	if (list) {
		...
		if (dBody) {
			...
			if (details["FLAG"]=="1") {
				...
				if (details["count_served_items"]===details['count_total_items']){
					options = '<img title="One or more items on this request has already been served..." src="../../images/served_item.jpg" />';
				}else if(details['count_served_items'] != details['count_total_items'] && details['count_served_items'] > 0){
					options = 'Partially <br />Serve';
				}
