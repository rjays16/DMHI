...
$aSubMenuItem=array('LDSegPharmaNewOrder' => '<a href="'.$root_path.'modules/pharmacy/apotheke-pass.php'. URL_APPEND."&userck=$userck".'&target=ordernew&area=ip">Create new request</a>',
										...
										'LDSegPharmaOrderServe' => '<a href="'.$root_path.'modules/pharmacy/apotheke-pass.php'. URL_APPEND."&userck=$userck".'&target=servelist">Serve request</a>',
