...
//pdf->SetFont($font,"B","11");
	...
	$pdf->Cell($maxW*0.10,5,'Item No.',$borderYes,$newLineNo,'C',$fillNo);
	$pdf->Cell($maxW*0.63,5,'Description',$borderYes,$newLineNo,'C',$fillNo);
	...
	while ($row = $result->FetchRow()) {
		$pdf->Cell($maxW*0.10,5,$row['bestellnum'],$borderYes,$newLineNo,'L',$fillNo);
		$pdf->Cell($maxW*0.63,5,$row['artikelname'],$borderYes,$newLineNo,'L',$fillNo);
		$pdf->Cell($maxW*0.10,5,number_format($row['force_price'],2),$borderYes,$newLineNo,'R',$fillNo);
