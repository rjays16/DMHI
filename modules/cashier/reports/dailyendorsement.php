...
//		$this->RepGen("CASHIER",'P',array(108,355.6));
	...
	function BeforeData() {
		...
		$image_offset = -12;
		$image_width = 12;
		$this->Image($root_path.'gui/img/logos/dmhi_logo.jpg',$total_w/2-$image_width+$image_offset,6,$image_width);
		//$total_w = 88;
		/*
	  ...
	  $this->Cell($total_w,3,'DEPARTMENT OF HEALTH',$border2,1,'C');
		...
		$this->Cell($pad,4);
  	$this->Cell($total_w,4,'DAVAO MEDIQUEST HOSPITAL INC',$border2,1,'C');
