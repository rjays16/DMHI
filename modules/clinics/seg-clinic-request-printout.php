...
class RepGen_Clinic_Requests_Slip extends RepGen {
	...
	function Header()
	{
		...
		//$this->Image($root_path.'gui/img/logos/dmhi_logo.jpg',4,4,7,8);
		$this->Image($root_path.'gui/img/logos/dmhi_logo.jpg',10,5,10,10);
		$total_w = 0;
		...
		$this->Cell(21,3, "Patient Name: ".strtoupper($person_info['name_last'].", ".$person_info['name_first']." ".$person_info['suffix']." ".$person_info['name_middle']), $border2, 0, 'L');
		$this->Ln(3);
		$this->printRequests();
		//	parent::Header();
	}
