...
function addPerson(listID, refno,batch_nr, name, code, serv_name, sked_date, sked_time, dept, rid, sked_by, skstatus,dept_short_name,pat_type, is_served, disabled_icon, bill, or_no) {
    ...
    if (list) {
        ...
        if (refno) {
            ...
            rowSrc = '<tr><td colspan="11">No scheduled requests available at this time...</td></tr>';
        }
...
<?php
  ...
  if (empty($rows))
    $rows = '<tr><td colspan="11">No scheduled requests available at this time...</td></tr>';
?>
...
<div id="tbContainer"  dojoType="TabContainer" style="width:100%; height:32em; display:block; border:1px;margin-bottom:-30px;" align="center">
...
<?php  #if ($waccess>1){?>
    <div dojoType="ContentPane" widgetId="tab0" label="All" style="display:none;overflow:auto;display:block; border:1px solid #8cadc0;margin-bottom:50px;">
        ...
        <tr>
            ...
            <th width="7%" align="center">OR No.</th>
