function jsRadioNoFoundRequest(sub_dept_nr){
	...
	if (dTable=document.getElementById('Ttab'+sub_dept_nr)) {
		...
		rowSrc = '<tr><td colspan="16" align="center" bgcolor="#FFFFFF" style="color:#FF0000; font-family:"Arial", Courier, mono; font-style:Bold; font-weight:bold; font-size:12px;">NO MATCHING PENDING REQUEST FOUND</td></tr>';
		dTBody.innerHTML += rowSrc;
//alert("jsRadioNoFoundRequest : dTBody.innerHTML : \n"+dTBody.innerHTML);
	}
}

function jsRadioRequest(sub_dept_nr,No,batchNo,refno,dateRq,sub_dept_name,pid,rid,sex,lName,fName,bDate,rStatus,rPriority,pType,service_code, borrow, borrow_details, is_served, request_flag, or_no){
