...
// alert(pid);
	xajax_checkifSC(refno);
	xajax_checkDone(refno);
...
function initialRequestList(serv_code,grp_code,name,c_info,r_doc,r_doc_name,n_house,cash,charge,hasPaid,sservice,parent_batch,head,remarks,qty,discounted_price,doc_dept,pay_type) {
...
function setphic(){
	if((!$('refno').value && ($('phic_nr').innerHTML != "" && $('phic_nr').innerHTML != "None")) && $('ptype').value != ""){
