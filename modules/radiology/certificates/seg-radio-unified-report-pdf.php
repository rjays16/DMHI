...
# Hospital Logo
$pdf->Image($root_path.'gui/img/logos/dmhi_logo.jpg',20,10,25,30);
...
foreach($batchNrArrayInfo as $batchNrInfo){
	 ...
	 $pdf->Ln(5);
		...
		$finding_and_empression .= '<table border=0 class="header_table" cellspacing="-1">
			<tr>
	            <td colspan=2 align=right><b><i>'.$result.'</i></b></td>
	        </tr>
	        <tr>
	            <td colspan=4><b>'.strtoupper($service_name).'</b></td>
	        </tr>
	        <tr>
	            <td colspan=4><b><font style="font-size:12pt;">FINDINGS :</font></b></td>
	        </tr>
        </table> ';
		$finding_and_empression .= $findings.'<br><br><b><font style="font-size:12pt;">IMPRESSIONS :<br></font></b>'.$radio_impression_final;
...
//		}
    ...
    $finding_and_empression .= '<br><br><br>
            <table border=0 class="footer_table" cellspacing="">
                <tr>';
                    foreach ($dr_arrys as $val_dr) {
                    $finding_and_empression .= '<td colspan=4 align=center>';
                    $finding_and_empression .= $val_dr['dr_info'];
                    $finding_and_empression .= '</td>';
                    }
	$finding_and_empression .= '</td>
	                </tr>
	        </table><br>';
