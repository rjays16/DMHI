                                                                ...
                                                                <tr>
                                                                        ...
                                                                        &nbsp&nbsp ROLE:                
                                                                              <select name="doc_level" id="doc_level" onchange="getRadioDoctor(this.value);"> 
                                                                                        ...
                                                                                        <option value="cm2">CHAIRMAN II</option>
                                                                                        <option value="cm1">CHAIRMAN I</option>
                                                                                </select>
