...
#           $objResponse->addAlert("radio-finding.server.php : deleteRadioServiceRequest : Successfully deleted! ");
            ...
            /*added by mai ^_^ 07-16-2014*/
                if ($comp_obj->deleteChargetoCompanyTransaction($ref_nr, 'RAD')){ //delete ledger charged to company
                    //success
                }else{
                    $objResponse->addScriptCall("msgPopUp","Unable to delete the request from company ledger.");
                }
            /*end added by mai*/
        }else{
...
$all_results = array();
    ...
    foreach($all_results as $row){
            ...
            $suffix = htmlentities($row['suffix']);
