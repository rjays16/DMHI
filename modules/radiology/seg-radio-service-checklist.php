				...
				<td class="segPanel">
					<table width="100%" style="font:bold 12px Arial; background-color:#e5e5e5;">
						...
						<tr>
							...
							<td align="left">
								<select class="segInput" id="radio_area" name="radio_area" onchange="list_radio_sections(this.value),populate_checklist('','')" style="width:300px;height:25px;">
									<option value="0">-Select Department-</option>
									<?
										$sql = "SELECT name_formal, nr FROM care_department WHERE parent_dept_nr='158' AND nr = '164' ORDER BY name_formal ASC";
						...
						<tr id="radio_section_row" style="display:none">
							...
							<td align="left">
									<select class="segInput" id="radio_section" name="radio_section" style="width:300px;height:25px;" onchange="populate_checklist(this.value,'')">
									</select>
									<img src="../../gui/img/common/default/redpfeil_l.gif">
								</div>
							</td>
