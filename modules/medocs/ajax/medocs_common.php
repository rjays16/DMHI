...
$xajax= new xajax($root_path."modules/medocs/ajax/medocs_server.php");
	...
	#add by ken 4/10/2014
	$xajax->registerFunction("saveAltDiagCode");
    ...
    #added by daryl
    #08/28/2014
    $xajax->registerFunction("populate_ICDRVS_Billing");
    $xajax->registerFunction("saveAltDiagDesc_bill");
    $xajax->registerFunction("saveAltDiagDesc_ICP");
    $xajax->registerFunction("saveAltDiagDesc_bill_ICP");
    $xajax->registerFunction("saveAltDiagDesc_bill_ICP2");
    $xajax->registerFunction("saveAltDiagDesc_seg");
    
    $xajax->registerFunction("searchReferral");
