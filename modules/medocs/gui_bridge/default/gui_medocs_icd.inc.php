...
<div id="icdSearchTab" style="border:0px solid black; padding:2px; background-color:#FFFFFF; width:100%; position:relative; display:block" align="center">
	<table width="100%" border="0" cellpadding="0" style="width:100%">
		<tr>
			<td width="100%" valign="top">
				<div style="width:99%;height:200px;overflow:hidden;border:1px solid black; margin-left:-4px;">
	...
	08/30/2014-->
		...
		<table id="icdCodeTable" class="segList" width="100%" border="0" cellpadding="0" cellspacing="0" style="overflow:auto">
			<thead>
				<tr>
		...
		<img id="ajax-loading" src="<?= $root_path ?>images/loading6.gif" align="absmiddle" border="0" style="display:none"/>
					...
					<!--id="DiagnosisList-body" table id="icdCodeTable" name="icdCodeTable" width="100%" border="0" cellpadding="0" cellspacing="1">
						<thead></thead>
						<tbody> -->
							 <!--
								 <tr></tr>
