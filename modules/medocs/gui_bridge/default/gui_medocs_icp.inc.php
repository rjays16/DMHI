		...
		<tr>
			<td width="100%" valign="top">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" id="srcRowsTable" style="font-size:10px">
						<thead>
							<tr class="reg_list_titlebar" style="font-weight:bold " id="srcRowsHeader" width="50%">
								...
								<th width="10%">
									<input id="btnAddIcpCode" type="button" value="Add" onFocus="hideDiv('icp');" onclick="if (checkDeptDocProcedureERMode(<?=$encounter_type?>)){ prepareAddIcpCode('<?= $HTTP_SESSION_VARS['sess_en'] ?>','<?=$encounter_type?>','<?= $HTTP_SESSION_VARS['sess_user_name'] ?>') }; char2();" style="width:100%">
								</th>
							</tr>
						</thead>
					</table>
				...
				<!-- 	<table id="icpCodeTable" width="100%" border="0" cellpadding="0" cellspacing="1">
					...
					<table id="icpCodeTable" class="segList" width="100%" border="0" cellpadding="0" cellspacing="0" style="overflow:auto">
			<thead>
				<tr id="">
