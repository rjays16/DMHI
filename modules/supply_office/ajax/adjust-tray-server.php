...
//    define('__DEBUG_MODE',1);
    function populateAdjustProductList($sElem, $page, $keyword, $area=NULL, $disable_qty=false, $filter=NULL) {
...
//                $athand = $eodinv->getCurrentEODQty($result["bestellnum"],$area,$date,'0000-00-00','');
                ...
                $skuids = $skuobj->getSKUIds($result["bestellnum"], $area, '', '', $details->pc_unitid);
                $details->pcsathand = $skuobj->getQtyofSKUs($skuids);
