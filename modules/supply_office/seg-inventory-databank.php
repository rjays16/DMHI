...
$plst = &$listgen->createList('plst',array('Type','Item Code','Item name/Generic name','Sell Price', 'Senior', 'Hosp. stock', ''),array(0,0,1,0,0,0,NULL),'populateProducts');
$plst->addMethod = 'addProductRow';
$plst->fetcherParams = array();
$plst->columnWidths = array("6%", "17%", "*", "11%", "9%", "7%", "8%");
