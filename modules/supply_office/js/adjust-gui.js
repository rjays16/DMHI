...
//                        var itemRow = $('row'+id+rowno),
                ...
                if (disabled)
                    ...
                    src+='<td class="centerAlign" width="3%"><img class="segSimulatedLink" src="../../images/close_small.gif" border="0" onclick="removeItem(\''+id+'\',\''+rowno+'\')"/></td>';
