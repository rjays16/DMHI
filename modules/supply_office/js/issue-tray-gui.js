        ...
        if (typeof(details) == "object") {
            ...
            rowSrc += '</td>' +
                '<td align="center" colspan="2">' +
                    '<input id="athand'+id+'" type="hidden" value="'+athand+'"/>'+
                    '<span id="rowathand'+id+'" style="color:#008000">'+athand+'</span></td>'+
                    '<td align="center" colspan="2">' +
                //'<input id="expiries'+id+'" type="hidden" value="'+pending+'"/>'+

                    '<input id="pending' + id + '" type="hidden" value="' + pending + '"/>' +
                '<input id="avg' + id + '" type="hidden" value="' + avg + '"/>' +
                '<input id="unitid' + id + '" type="hidden" value="' + pc_unitid1 + '"/>' +
                '<input id="unitdesc' + id + '" type="hidden" value="' + pc_unitname1 + '"/>' +
                '<input id="pckunitid' + id + '" type="hidden" value="' + pck_unitid1 + '"/>' +
                '<input id="pckunitdesc' + id + '" type="hidden" value="' + pck_unitname1 + '"/>' +
                '<input id="qtyperpack' + id + '" type="hidden" value="' + qtyperpack + '"/>' +
                '<input id="perpc' + id + '" type="hidden" value="' + perpc + '"/><span id = "' + id + '" style="color:#008000">' + pending + '</span></td>' +
                '<td align="center">' +
                '<input class="segButton" type="button" id="' + packId + '" value="' + pck_unitname1 + '" style="color:#000066; font-weight:bold;" ';
            //'onclick="prepareAdd(\''+id+'\')" '+
            rowSrc += '/>' +
                '</td>' +
                '<td align="center">' +
                '<input class="segButton" type="button" id="' + pcId + '" value="' + pc_unitname1 + '" style="color:#000066; font-weight:bold;" ' +
...
//        }
            ...
            rowSrc = '<tr><td colspan="10" style="">No such product exists...</td></tr>';
        }
