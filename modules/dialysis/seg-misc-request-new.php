...
$person_name = ucwords($person_info['name_last']). ', ' . ucwords($person_info['name_first']).' '.ucwords($person_info['suffix']). ' ' . $middle_initial;
...
$transaction_date_display = $row['chrge_dte'] ? date('F d, Y h:ia', strtotime($row['chrge_dte'])) : date('F d, Y h:ia');
$transaction_date = $row['chrge_dte'] ? date('Y-m-d H:i', strtotime($row['chrge_dte'])) : date('Y-m-d H:i');
