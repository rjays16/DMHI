...
class CF4Helper
{
    ...
    public static function getHciProvince()
    {
        $data = EclaimsConfig::model()->findbyAttributes(array(
            'type' => 'eclaims_cf4_province',
        ))->value;

        return $data;
    }

    public static function getHciCity()
    {
        $data = EclaimsConfig::model()->findbyAttributes(array(
            'type' => 'eclaims_cf4_city',
        ))->value;

        return $data;
    }

    public static function getHciZipCode()
    {
        $data = EclaimsConfig::model()->findbyAttributes(array(
            'type' => 'eclaims_cf4_zipcode',
        ))->value;
