...
class EncounterInsuranceService
{
    ...
    {
        $phic = PhicMember::model()->findByAttributes(array(
    ...
    {
        $memberCategory = EncounterMemcategory::model()->findByAttributes(array(
            'encounter_nr' => $this->encounter->encounter_nr,
        ));
    ...
    public function addInsurance()
    {
        ...
        $model = EclaimsPersonInsurance::model()->findByAttributes(array(
            'pid' => $this->person->pid,
        ));
