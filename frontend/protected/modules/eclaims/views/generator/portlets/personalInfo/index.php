        ...
        $this->widget('bootstrap.widgets.TbDetailView', array(
            ...
            'attributes'   => array(
                array(
                    ...
                    'value' => $encounter->encounter_type == $er || $encounter->encounter_type == $opd  ? date('M d, Y h:i a', strtotime($encounter->encounter_date)) : date('M d, Y h:i a', strtotime($encounter->admission_dt)),
                ),
                array(
