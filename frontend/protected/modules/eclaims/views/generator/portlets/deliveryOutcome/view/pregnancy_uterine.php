<div class="row-fluid">
    <div class="span12 offset-3">
        ...
        <?php
        $list = CHtml::listData($maternalOutcome, 'value', 'detail');
        echo $form->dropDownList(
            ...
            array(
                ...
                'required' => true,
                'options' => array(
                    $pregnancyUterine->maternal_outcome != '' ? $pregnancyUterine->maternal_outcome : ''  => array('selected' => true)
                ),
...
<div class="row-fluid">
    <div class="span6">
        ...
        echo $form->NumberFieldRow($pregnancyUterine, 'aog_by_lmp', array(
