...
class EclaimsTransmittalDetails extends TransmittalDetails {
	...
	public function relations() {
		return array_merge(parent::relations(), array(
            ...
            'eligibility' => array(self::HAS_ONE, 'Eligibility', array('encounter_nr' => 'encounter_nr'), 'through' => 'encounter'),
            'memberType' => array(self::HAS_ONE, 'PhicMember', array('encounter_nr' => 'encounter_nr'), 'through' => 'encounter'),
            'encounter' => array(self::BELONGS_TO, 'EclaimsEncounter', 'encounter_nr'),
            'attachments' => array(self::HAS_MANY, 'ClaimAttachment', array(
