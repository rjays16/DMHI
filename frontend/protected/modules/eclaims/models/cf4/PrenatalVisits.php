...
class PrenatalVisits extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('entry_id, encounter_nr, date_visit, aog', 'required'),

			array('id, entry_id', 'length', 'max' => 36),
			array('encounter_nr', 'length', 'max' => 15),
			array('entry_id, encounter_nr, date_visit, aog, weight, cardiac_rate, respiratory_rate, bp, temperature', 'safe'),
